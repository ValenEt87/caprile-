    ...
    return (
        <>
            ...
            <section className="grid grid-cols-12 mx-5 mb-24 mt-24 gap-5 items-center">
                ...
                <div
                    className="col-span-10 col-start-2 lg:col-span-5 lg:col-start-2 px-2"
                    data-aos="fade-up"
                ...
                <div
                    className="col-span-10 col-start-2 lg:col-start-7 lg:col-span-5 px-2"
                    data-aos="fade-up"
                    data-aos-duration="1000"
                    data-aos-easing="ease-in-out"
                    data-aos-delay="300"
                >
                    ...
                    <p className="px-1">
                        Nuestra empresa se encuentra entre las más reconocidas del país y hemos
                        trabajado en numerosas canchas de Argentina, Chile, Uruguay y Brasil.
                    ...
                    <a href="/sobre-nosotros" className="color-white-bmr font-bold bg-green-caprile hover:bg-green-900 py-3 px-6 lg:px-5 rounded-lg transition duration-300 ease-in-out">
                        Sobre nosotros
                    </a>
                    <a href="/sobre-nosotros" className="font-bold border border-2 py-2 px-6 lg:px-10 rounded-lg transition duration-300 ease-in-out items-center">
                        Contactanos
                    </a>
                    </div>
                </div>
                ...
                <section className="bg-green-900 text-white lg:h-dvh bg-services bg-fixed">
                    <div className="flex flex-col items-center justify-center gap-4 px-4 py-6 lg:py-0 items-center h-full">
                        ...
                        <div className="bg-white text-gray-900 rounded-xl shadow-lg p-6 w-1/2">
                ...
                {/* <section className="bg-green-900 text-white lg:relative lg:h-[650px] bg-services bg-fixed">
                    <div className="grid grid-cols-12 gap-4 px-4 py-6 lg:py-0 items-center h-full lg:relative">
                        ...
                        <div className="col-span-10 col-start-2 col lg:col-start-2 lg:col-span-5">
                        ...
                        {/* Formulario */}
                        {/* <div className="col-span-10 col-start-2 lg:col-start-7 lg:col-span-5 bg-white text-gray-900 rounded-xl shadow-lg p-6 lg:absolute lg:left-1/2 lg:transform lg:-translate-x-1/2 lg:-top-30 w-full">
                            <form className="space-y-4">
                                <div>
                                <label htmlFor="name" className="block text-sm font-semibold mb-1">
                                    Nombre completo
                                ...
                                <button
                                type="submit"
                                className="w-full bg-green-caprile text-white font-semibold py-3 rounded-lg hover:bg-green-600 transition duration-300"
                                >
                                    Enviar
                                </button>
                            </form>
