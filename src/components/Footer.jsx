  ...
  return (
    <footer className="dark:bg-gray-900 pt-10 lg:pt-16 border-t border-[rgb(206,201,193)]">
        <div className="2xl:mx-auto w-full grid grid-cols-12 md:gap-5 gap-2 lg:mx-5 ">
            <div className="mb-6 md:mb-0 col-span-10 col-start-2 lg:col-span-4 lg:col-start-2 md:col-start-2 md:col-span-10">
                ...
                <div className="flex space-x-2">
                    <a
                        href="#"
                        className="bg-green-800 hover:bg-green-700 p-3 rounded-lg transition duration-300"
                        aria-label="Facebook"
                    >
                    ...
                    <a
                        href="https://www.instagram.com/caprilegolf/"
                        className="bg-green-800 hover:bg-green-700 p-3 rounded-lg transition duration-300"
                    ...
                    <a
                        href="https://wa.me/54911552284962?text=¡Hola!%20vengo%20desde%20la%20web%"
                        className="bg-green-800 hover:bg-green-700 p-3 rounded-lg transition duration-300"
                        aria-label="WhatsApp"
                    >
            ...
            <div className="lg:col-start-7 lg:col-span-5 col-span-10 col-start-2 grid md:grid-cols-2 gap-8 sm:gap-5">
                ...
                <div className="flex flex-col md:text-center md:text-start md:mt-3 md:mt-0">
                    ...
                    <ul className="text-slate-300 font-medium mt-3">
                        ...
                        <li className="mb-4">
                            <a href="https://wa.me/54911552284962?text=¡Hola!%20vengo%20desde%20la%20web%" aria-label="Mensaje de WhatsApp a la empresa" target="_blank" className="nav-link flex items-center">
        ...
        <div className="col-span-12 bg-green-950 py-2 text-white text-center text-sm flex justify-center items-center gap-2">
            <span className="text-[13px]">Hecho a través de</span>
