...
const Footer = () => {
  ...
  return (
    <footer className="dark:bg-gray-900">
        <div className="2xl:mx-auto w-full py-6 lg:py-8 grid grid-cols-12 md:gap-5 gap-2 lg:mx-5 justify-items-center">
            <div className="mb-6 md:mb-0 col-span-12 lg:col-span-4 md:col-start-2 md:col-span-10">
                ...
                <div className="flex justify-center lg:justify-start space-x-2">
                    <a
                        href="#"
                        className="bg-green-700 hover:bg-green-600 p-3 rounded-lg transition duration-300"
                        aria-label="Facebook"
                    >
            ...
            <div className="lg:col-start-7 lg:col-span-5 col-span-10 col-start-2 grid md:grid-cols-2 gap-8 sm:gap-5">
                ...
                <div className="flex flex-col text-center md:text-start mt-3 md:mt-0">
        ...
        <div className="sm:flex sm:items-center sm:justify-between text-center col-span-12">
