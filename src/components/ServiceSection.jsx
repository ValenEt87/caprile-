  ...
  return (
    <div className={`accordion-item ${isOpen ? "active" : ""}`}>
      <div
        ...
        onClick={onClick}
      >
        <h3 className="font-medium text-xl color-white-bmr">{title}</h3>
        {isOpen ? (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
...
const ServiceSection = () => {
  ...
  return (
    <section className="py-20 bg-fixed bg-center bg-no-repeat grid grid-cols-12 px-5 gap-5">
      ...
      <div className="bg-fixed col-span-12 lg:col-span-6 col-start-2 lg:col-start-7 flex flex-col justify-center items-start">
