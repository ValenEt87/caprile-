...
const ServiceSection = () => {
  ...
  return (
    <section className="py-8 lg:pb-20 lg:pt-28 bg-fixed bg-center bg-no-repeat grid grid-cols-12 mx-5 md:px-5 md:gap-5"  data-aos="fade-up" data-aos-duration="800" data-aos-easing="ease-in-out">
